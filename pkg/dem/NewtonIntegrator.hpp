...
class NewtonIntegrator : public FieldApplier{
	...
	YADE_CLASS_BASE_DOC_ATTRS_CTOR_PY(NewtonIntegrator,GlobalEngine,"Engine integrating newtonian motion equations.",
		...
		((Real,linDamping,0.0,,"translational background viscous damping (see https://www2.msm.ctw.utwente.nl/sluding/PAPERS/GM_CHOPScontacts.pdf)"))
		((Real,rotDamping,0.0,,"rotational background viscous damping (see https://www2.msm.ctw.utwente.nl/sluding/PAPERS/GM_CHOPScontacts.pdf)"))
